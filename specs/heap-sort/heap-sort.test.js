...
const createMaxHeap = (array) => {
  // function that loops over array and calls heapify in reverse order
...
const heapify = (array, index, heapSize) => {
  // uses a little bit of recursion
  // am i in right place? am i bigger than my children? do i need to swap?
